...
install:
	...
	install -m 755 discord-installer.{service,timer} ${DESTDIR}/usr/lib/systemd/system
	install -m 755 discord-canary-installer.{service,timer} ${DESTDIR}/usr/lib/systemd/system
